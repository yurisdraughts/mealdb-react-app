...
export default function Layout() {
    ...
    useEffect(() => {
        ...
        // Areas:
            ...
            document.title
                = prefix + separator + 'Areas';
        } else if (pathname.startsWith('/areas/')) {
            document.title
                = prefix + separator
                + decodeURI(pathname.substring('/areas/'.length));
        }

        // First Letters:
        else if (pathname === '/first-letters') {
            document.title
                = prefix + separator + 'First Letters';
        ...
        // Meal:
            ...
            document.title
                = prefix + separator + titleSuffix;
        }

        // Else:
        else {
            document.title
                = prefix + separator + defaultTitleSuffix;
        }
